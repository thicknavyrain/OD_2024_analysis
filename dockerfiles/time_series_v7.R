...
model_fit <- glmmTMB(formula, 
                     ...
                     control = glmmTMBControl(
                        optCtrl = list(iter.max = 50, eval.max = 50)  # Increase the maximum number of iterations
                     ))
...
# Save the results to a CSV file for later use in Python
write_csv(tidy_result, paste0(site, '_model_coefficients.csv'))
